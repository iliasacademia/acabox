...
export const FEATURES: {
  ...
  GOOGLE_DOCS_INTEGRATION_ENABLED: true, // Build-time default; runtime enable lives in user settings (Settings → Google Docs Integration). Routes the overlay over Chrome when the active tab is a Google Doc.
