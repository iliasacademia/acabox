...
export function createDocumentReaderMcpServer(directoryPaths: string[]) {
  ...
  return createSdkMcpServer({
    ...
    tools: [
      tool(
        ...
        'Use this whenever you need to read the content of a Word document or PDF.',
        {
          file_path: z.string().describe('Absolute path to the .docx or .pdf file.'),
