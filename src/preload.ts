...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  invoke: (channel: string, ...args: any[]) => {
    const validChannels = ['check-login', 'login', 'logout', 'select-folder', 'upload-files', 'search-files', 'get-notifications', 'update-notification', 'get-current-user', 'get-screen-sources', 'get-all-sources', 'close-overlay', 'get-word-content', 'test-accessibility', 'test-word-api', 'check-word-frontmost', 'update-overlay-visibility', 'get-word-scroll-position', 'get-word-text', 'process-screen-ocr', 'close-overlay', 'get-sync-folders', 'add-sync-folder', 'remove-sync-folder', 'sync-folder-now', 'get-folder-files', 'process-word-window'];
